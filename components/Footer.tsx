  ...
  return (
    <>
      <footer className="bg-gray-900 text-white hidden lg:block">
        <div className="max-w-[1440px] px-6 md:px-16 py-5  mx-auto">
          <ItemsContainer />
          <div className=" h-1 bg-[#d9d9d9] -mt-5"></div>
          <div
       ...
       text-white pb-8 text-base lg:text-lg font-normal my-10"
          >
            <span className="">
              Copyright © {new Date().getFullYear()} Bytewave Technologies
              Limited.
            </span>
            <span>
      ...
      {/* mobile */}
      <footer className="lg:hidden bg-gray-900 text-white py-10 px-5">
        <div className="grid grid-cols-2 items-center gap-y-16">
          ...
          <ul className=" ">
            <h1 className="mb-3 font-semibold text-xs ">INFO</h1>
            <li className="flex items-center mb-4 gap-2">
              ...
              <a
                href="#"
                className={`text-[#ABABAB] hover:text-purple-600 duration-300
            text-[11px] w-5/6  cursor-pointer leading-tight whitespace-nowrap `}
              >
          ...
          {/* newsletter */}
          <div className="flex flex-col">
            <h1 className="mb-3 font-bold text-sm whitespace-nowrap">
        ...
        <div className="w-full mx-auto h-1 bg-[#d9d9d9] mb-5"></div>
        <div
          className=" mx-auto flex flex-col gap-3 items-center 
       text-[#ABABAB] pb-8 text-xs mt-10 text-center"
        >
          <span className="">
            Copyright © {new Date().getFullYear()} Bytewave Technologies
            Limited.
