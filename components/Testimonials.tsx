...
const Testimonials = (props: Props) => {
  return (
    <>
      <section className="hidden lg:block bg-who-section bg-center bg-no-repeat bg-cover w-full py-32 overflow-hidden">
        <div className="relative max-w-[1280px] mx-auto">
          ...
          <div className="relative w-[50%] rounded-xl bg-testimonies bg-center bg-no-repeat bg-cover py-28 mx-auto my-16 flex items-center justify-center ">
            ...
            <p className="max-w-[428px] text-[#94A2B3] text-[18px] text-center leading-9  ">
              Working with the BYTEWAVE TECHNOLOGIES team has been a huge
              success! <br />
            ...
            <Image
              src={testi1}
              alt=""
              className="w-[355px] absolute -bottom-5 -left-24 -z-10"
            />
            <Image
              src={testi2}
              alt=""
              className="w-[355px]  absolute top-10 -right-16 -z-10"
            />
            <Image
              src={p1}
              alt=""
          ...
          <div className="flex items-center gap-5 justify-center ml-72 -mt-16">
      ...
      <section className="lg:hidden ">
        <div className="text-center">
          <h1 className="text-[#7854f7] font-semibold text-sm">Testimonials</h1>
          <p className="font-medium text-xs text-[#272d4e] mt-2">
            See What Clients Feel About Us
          </p>
        </div>

        <div className="bg-who-section bg-center bg-no-repeat bg-cover w-full h-full flex items-center justify-center my-16 ">
          <div className="relative w-5/6 rounded-xl bg-testimonies bg-center bg-no-repeat bg-cover py-14 mx-auto my-10 flex items-center justify-center">
            {/* <Image src={testimonial} alt="" className="relative w-full" /> */}
            <div className="z-50">
              <p className=" w-5/6 mx-auto text-[#94A2B3] text-[12px] text-center leading-6 ">
                Working with the BYTEWAVE TECHNOLOGIES team has been a huge
                success! <br />
                They're good people who care deeply about our business. More
                importantly, Bytewave doesn't charge you a portion of your
