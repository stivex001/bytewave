  ...
  return (
    <section className="relative bg-[#E9F1FF] w-full">
      <Image
        src={absImg}
        alt=""
        className=" absolute bottom-0 left-0  w-full z-[999] "
      />
      <div className="max-w-[1440px] px-6 md:px-16 2xl:px-0 min-h-[630px] hero  mx-auto  py-5 lg:py-20  bg-hero bg-bottom lg:bg-right bg-no-repeat bg-contain lg:min-h-[660px] z-10 relative">
          ...
          >
            ...
            <span className="relative  inline-block">
              ...
              <Image
                src={decoy}
                alt=""
                className="absolute bottom-1 lg:bottom-3 "
              />
            </span>{" "}
